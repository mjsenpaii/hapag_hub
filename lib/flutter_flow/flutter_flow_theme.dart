...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFFA31A);
  late Color secondary = const Color(0xFFE24D2D);
  ...
  late Color accent1 = const Color(0xFFFFBB00);
  ...
  late Color gold = const Color(0xFFFFD700);
  late Color border = const Color(0xFF555555);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFFA31A);
  late Color secondary = const Color(0xFFE04E2A);
  ...
  late Color accent2 = const Color(0xFFFF3B00);
  late Color accent3 = const Color(0xFFFF6B00);
  late Color accent4 = const Color(0xFFFFA700);
  ...
  late Color gold = const Color(0xFFFFD700);
  late Color border = const Color(0xFFFFA31A);
}
